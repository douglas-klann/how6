...
$sql = "SELECT id, nome, pais, descricao FROM Marca";
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="php/delect_marca.php?id=<?php echo $row["id"] ?>"><button type="button" class="btn btn-danger">Excluir</button></a></td>
                      </tr>
